export enum ActionType {
  ...
  USER_ORDER_LIST_REQUEST = "USER_ORDER_LIST_REQUEST",
  USER_ORDER_LIST_SUCCESS = "USER_ORDER_LIST_SUCCESS",
  USER_ORDER_LIST_FAIL = "USER_ORDER_LIST_FAIL",
  USER_ORDER_LIST_RESET = "USER_ORDER_LIST_RESET",
